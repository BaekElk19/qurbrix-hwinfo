...
| Q6 | `dmidecode -t 11` OEM Strings 采集 | 主板/BIOS 探针 | OEM 机型识别 (fixed in 738e7c1) |
| Q7 | 存储分区 & 挂载：`lsblk -O -J` 加 `MOUNTPOINT/FSTYPE/PARTUUID/LABEL` | `existing.rs:2872` | 主流工具基础特性 (fixed in fa2f571) |
