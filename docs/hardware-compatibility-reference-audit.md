...
- P2: add network NM DBus enrichment, storage controller/lshw/hdparm enrichment, richer multi-interface USB modeling, camera lshw/hwinfo enrichment, audio hwinfo/profile enrichment, and Bluetooth lshw/DBus enrichments.
