...
- P2: add network DBus/lshw human-readable enrichment, storage controller/lshw/hdparm enrichment, richer multi-interface USB modeling, camera lshw/hwinfo enrichment, audio lshw/hwinfo/PCI fusion, and Bluetooth lshw/DBus enrichments.
