...
- Input, printer, and CD-ROM still have limited fallback/enrichment coverage compared with the reference projects; audio still has limited SoC vendor alias coverage; camera still lacks hwinfo enrichment.
